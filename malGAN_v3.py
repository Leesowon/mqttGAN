...
# generator : 입력 레이어：128（특징 차원）+20（잡음 차원) / 은닉 레이어：256  출력 레이어：128
...
class MalGAN():
    def __init__(self, blackbox='RF', same_train_data=1, filename='D:/workspace/GAN/Malware-GAN-master/data.npz'):
        ...
        # optimizer = tf.optimizers.Adam(learning_rate=0.001).minimize(loss, var_list)
