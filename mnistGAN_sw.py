...
'''
ben_origin_data = pd.read_csv("D:/workspace/GAN/swGAN/data/mqttdataset_legitimate_10000.csv")
mal_origin_data = pd.read_csv("D:/workspace/GAN/swGAN/data/mqttdataset_malicious_10000.csv")

# 상위 1000개 데이터 선택 후 .csv로 저장
xben = ben_origin_data.head(1000)
xben.to_csv('D:/workspace/GAN/swGAN/data/mqttdataset_legitimate_1000.csv', index=False)
xmal = mal_origin_data.head(1000)
xmal.to_csv('D:/workspace/GAN/swGAN/data/mqttdataset_malicious_1000.csv', index=False)
...
ben_data = pd.read_csv("D:/workspace/GAN/swGAN/data/mqttdataset_legitimate_1000.csv")
mal_data = pd.read_csv("D:/workspace/GAN/swGAN/data/mqttdataset_legitimate_1000.csv")
...
def train(args):
    ...
    num_of_normal = 1000
    num_of_mal = 1000
    xben = pd.read_csv('D:/workspace/GAN/swGAN/data/mqttdataset_legitimate_1000.csv')
    yben = np.zeros(num_of_normal)  # 레이블 : 정상 0
    xmal = pd.read_csv('D:/workspace/GAN/swGAN/data/mqttdataset_malicious_1000.csv')
